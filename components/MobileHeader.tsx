...
export const MobileHeader: React.FC<MobileHeaderProps> = ({ onMenuClick }) => {
  return (
    <div className="md:hidden flex items-center h-16 bg-gray-800 text-white px-4 border-b border-gray-700 flex-shrink-0">
      <button onClick={onMenuClick} className="p-2 rounded-md text-gray-300 hover:bg-gray-700 hover:text-white">
        <Bars3Icon className="h-6 w-6" />
      </button>
      <h1 className="text-lg font-bold ml-4">meez</h1>
    </div>
  );
};
