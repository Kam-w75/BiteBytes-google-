...
const ImportTile: React.FC<{
    ...
    <div className="bg-[#2C2C2C] p-6 rounded-lg shadow-sm border border-[#444444] flex flex-col items-center text-center hover:shadow-lg hover:border-gray-600 transition-shadow">
        <div className="bg-[#FF6B6B]/10 p-4 rounded-full text-[#FF6B6B] mb-4">
            {icon}
        </div>
        <h3 className="text-lg font-bold text-gray-200">{title}</h3>
        <p className="text-sm text-gray-400 mt-1 mb-4 flex-grow">{subtitle}</p>
        <button className="w-full px-4 py-2 font-semibold text-black bg-[#FF6B6B] rounded-md shadow-sm hover:bg-[#E85A5A]">
            {buttonText}
        </button>
...
export const ImportExportHub: React.FC = () => {
    const formatButtons = (
        <>
            <button className="px-3 py-1 text-xs font-semibold text-gray-300 bg-gray-700 rounded-md hover:bg-gray-600">Excel</button>
            <button className="px-3 py-1 text-xs font-semibold text-gray-300 bg-gray-700 rounded-md hover:bg-gray-600">CSV</button>
            <button className="px-3 py-1 text-xs font-semibold text-gray-300 bg-gray-700 rounded-md hover:bg-gray-600">PDF</button>
        </>
    );
                ...
                <section>
                    ...
                    <div className="space-y-4">
                        ...
                        <ExportRow title="Reports" subtitle="Weekly/Monthly cost analysis">
                            <select className="px-3 py-1 text-xs font-semibold text-gray-300 bg-gray-700 rounded-md hover:bg-gray-600 border-none focus:ring-0">
                                <option>Weekly Report</option>
                                <option>Monthly Report</option>
                            </select>
                            <button className="px-3 py-1 text-xs font-semibold text-black bg-[#FF6B6B] rounded-md hover:bg-[#E85A5A]">Export</button>
                        </ExportRow>
